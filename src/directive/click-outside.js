    ...
    {},
    {
        ...
        bind: {
            value: function bind(el, binding) {
                ...
                if (
                    instances[arg].push({ el, binding: normalisedBinding }) ===
                    1
                ) {
        ...
        unbind: {
            value: function unbind(el) {
                ...
                const instancesIteratee = function _instancesIteratee(
                    instances
                ) {
                    ...
                    if (instanceKeys.length) {
                        ...
                        const keysIteratee = function _keysIteratee(eventName) {
                            const newInstance = instances[eventName].filter(
                                compareElements
                            );
